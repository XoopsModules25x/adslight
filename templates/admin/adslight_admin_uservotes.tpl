<{if $uservotesRows > 0}>
    <div class="outer">
         <form name="select" action="uservotes.php?op=" method="POST"
          ...
          <table class="$uservotes" cellpadding="0" cellspacing="0" width="100%">
            <tr><th align="center" width="5%"><input name="allbox" title="allbox" id="allbox" onclick="xoopsCheckAll('select', 'allbox');" type="checkbox" title="Check All"  value="Check All" ></th>  <th class="left"><{$selectorratingid}></th>  <th class="left"><{$selectorusid}></th>  <th class="left"><{$selectorratinguser}></th>  <th class="left"><{$selectorrating}></th>  <th class="left"><{$selectorratinghostname}></th>  <th class="left"><{$selectorratingtimestamp}></th>

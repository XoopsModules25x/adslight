    ...
    <div class="outer">
         <form name="select" action="replies.php?op=" method="POST"
          ...
          <table class="$replies" cellpadding="0" cellspacing="0" width="100%">
            <tr><th align="center" width="5%"><input name="allbox" title="allbox" id="allbox" onclick="xoopsCheckAll('select', 'allbox');" type="checkbox" title="Check All"  value="Check All" ></th>  <th class="left"><{$selectorr_lid}></th>  <th class="left"><{$selectorlid}></th>  <th class="left"><{$selectortitle}></th>  <th class="left"><{$selectordate}></th>  <th class="left"><{$selectorsubmitter}></th>  <th class="left"><{$selectormessage}></th>  <th class="left"><{$selectortele}></th>  <th class="left"><{$selectoremail}></th>  <th class="left"><{$selectorr_usid}></th>

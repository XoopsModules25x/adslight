<{if $iplogRows > 0}>
    <div class="outer">
         <form name="select" action="iplog.php?op=" method="POST"
          ...
          <table class="$iplog" cellpadding="0" cellspacing="0" width="100%">
            <tr><th align="center" width="5%"><input name="allbox" title="allbox" id="allbox" onclick="xoopsCheckAll('select', 'allbox');" type="checkbox" title="Check All"  value="Check All" ></th>  <th class="left"><{$selectorip_id}></th>  <th class="left"><{$selectorlid}></th>  <th class="left"><{$selectordate_created}></th>  <th class="left"><{$selectorsubmitter}></th>  <th class="left"><{$selectoripnumber}></th>  <th class="left"><{$selectoremail}></th>

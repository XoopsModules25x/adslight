<{if $picturesRows > 0}>
    <div class="outer">
         <form name="select" action="pictures.php?op=" method="POST"
          ...
          <table class="$pictures" cellpadding="0" cellspacing="0" width="100%">
            <tr><th align="center" width="5%"><input name="allbox" title="allbox" id="allbox" onclick="xoopsCheckAll('select', 'allbox');" type="checkbox" title="Check All"  value="Check All" ></th>  <th class="left"><{$selectorcod_img}></th>  <th class="left"><{$selectortitle}></th>  <th class="left"><{$selectordate_created}></th>  <th class="left"><{$selectordate_updated}></th>  <th class="left"><{$selectorlid}></th>  <th class="left"><{$selectoruid_owner}></th>  <th class="left"><{$selectorurl}></th>

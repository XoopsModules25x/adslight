<form action="<{$xoops_url}>/modules/xpayment/" method="post">
    ...
    <{php}> } else { <{/php}>
    <label><{$smarty.const._MN_ADSLIGHT_YOURNAME}>&nbsp;</label><input type="text" name="drawto" value="" size="15"
                                                                       maxlen="128"><br>
    <label><{$smarty.const._MN_ADSLIGHT_YOUREMAIL}>&nbsp;</label><input type="text" name="drawto_email" value=""
                                                                        size="15" maxlen="128"><br>
    <{php}> } <{/php}>

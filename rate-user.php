...
if (!empty($HTTP_POST_VARS['submit'])) {
    ...
    $datetime = time();
    $sql      =
        sprintf("INSERT INTO %s (ratingid, usid, ratinguser, rating, ratinghostname, ratingtimestamp) VALUES (%u, %u, %u, %u, '%s', %u)", $xoopsDB->prefix('adslight_user_votedata'), $newid, $usid,
    ...
    $xoopsOption['template_main'] = 'adslight_rate_user.tpl';

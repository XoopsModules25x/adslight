  ...
  <tr>
    <td align="center">
      <form method="post" action="rate-user.php">
        ...
        <input type="submit" name="submit" value="<{$lang_rateit}>" /><input type=button value="<{$lang_cancel}>" onclick="location='<{$xoops_url}>/modules/adslight/index.php?pa=viewmyads&usid=<{$link.usid}>'" />
      </form>
    </td>
  </tr>
</table>

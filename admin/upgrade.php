...
//  Add the new fields to the listing table
    ...
    if ($errors) {
        ...
        echo "" . constant($admin_lang . "_UPDATECOMPLETE") . " - <a href='" . XOOPS_URL . "/modules/system/admin.php?fct=modulesadmin&op=update&module=$moduleDirName'>" . constant(
                $admin_lang . "_UPDATEMODULE"
            ) . "</a>";
    }
} else {

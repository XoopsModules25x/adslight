...
define('_AM_ADSLIGHT_ADD', 'Rédiger l\'article');
...
define('_AM_ADSLIGHT_DEL', 'Effacer');
define('_AM_ADSLIGHT_SAVMOD', 'Sauvegarder vos modifications');
...
define('_AM_ADSLIGHT_MODSUBCAT', 'Modifier le nom de la sous-catégorie');
define('_AM_ADSLIGHT_MODCAT', 'Modifier le nom de la catégorie principale');
define('_AM_ADSLIGHT_GO', 'Aller');
...
define('_AM_ADSLIGHT_TYPE', 'Type d\'annonce :');
...
define('_AM_ADSLIGHT_ORDER', 'Ordre :');
define('_AM_ADSLIGHT_ORDERCLASS', 'Catégorie de commande :');
define('_AM_ADSLIGHT_ORDERALPHA', 'Tri alphabétique');
define('_AM_ADSLIGHT_ORDERPERSO', 'Tri personnalisé');
...
// fichier pref.php //
define('_AM_ADSLIGHT_CONFSAVE', 'Configuration sauvegardée');
...
define('_AM_ADSLIGHT_CURRENCY_SYMBOL', 'Symbole de la devise :');
...
define('_AM_ADSLIGHT_ISAT', 'est à');
define('_AM_ADSLIGHT_VIEWNEWCLASS', 'Afficher les nouvelles annonces :');
define('_AM_ADSLIGHT_PERMADDNG', 'Impossibilité d\'ajouter %s permission pour %s pour le groupe %s');
...
define('_AM_ADSLIGHT_PERMADDNGP', 'Tous les éléments parents doivent être sélectionnés.');
...
define('_AM_ADSLIGHT_OK', 'Approuver');
...
define('_AM_ADSLIGHT_SOLD', 'Cette petite annonce est : <br /><font color="red"><strong>[Réservée]</strong></font>');
define('_AM_ADSLIGHT_STATUS', 'Statut');
define('_AM_ADSLIGHT_UPDATECOMPLETE', 'Mise à jour terminée');
define('_AM_ADSLIGHT_UPDATEMODULE', '<strong>Mettre à jour le module</strong>');
define('_AM_ADSLIGHT_UPGRADEFAILED', 'La mise à jour a échoué');
//define('_AM_ADSLIGHT_UPGRADEFAILED0', 'Mise à jour');
...
define('_AM_ADSLIGHT_EXPIRED', 'Votre annonce a expiré et a été supprimée.');
...
define('_AM_ADSLIGHT_LISTING_NUMBER', 'Numéro d\'annonce');
define('_AM_ADSLIGHT_YOU_CAN_VIEW_BELOW', 'Vous pouvez voir la liste complète sur le lien ci-dessous');
...
define('_AM_ADSLIGHT_RECIEVING_NOTIF', 'Vous avez souscrit à la réception de notifications de ce genre.');
define('_AM_ADSLIGHT_ERROR_NOTIF', 'S\'il s\'agit d\'une erreur ou si vous souhaitez ne plus recevoir ces notifications, veuillez mettre à jour vos abonnements en visitant le lien ci-dessous :');
define('_AM_ADSLIGHT_FOLLOW_LINK', 'Ceci est le lien vers la nouvelle offre d\'emploi');
...
define('_AM_ADSLIGHT_FEATURES', 'Caractéristiques');
...
define('_AM_ADSLIGHT_ABOUT_CHANGELOG', 'Journal des modifications');
...
define('_AM_ADSLIGHT_PERSONS_PARTICIP_DESC', 'Vue d\'ensemble');
//groupperms.php
define('_AM_ADSLIGHT_GPERM_G_ADD', 'Peut ajouter');
define('_AM_ADSLIGHT_CAT2GROUPDESC', 'Vérifiez les catégories qui vous permettent d\'accéder');
define('_AM_ADSLIGHT_GROUPPERMDESC', 'Sélectionner les groupes autorisés à soumettre des annonces.');
...
define('_AM_ADSLIGHT_VIEW_RESUMEFORM_DESC', 'Sélectionner qui peut voir les CV');
...
define('_AM_ADSLIGHT_MENURSSFORUM_GOFORUM', 'Aller au Forum');
define('_AM_ADSLIGHT_MENURSSFORUM_LINK2', 'http://www.i-luc.fr/adslight/modules/profile/register.php');
define('_AM_ADSLIGHT_MENURSSFORUM_SUBSCRIT', 'S\'inscrire');
////    RSS AdsLight News
...
define('_AM_ADSLIGHT_ERRORPRICE', 'Erreur de prix');
define('_AM_ADSLIGHT_ERRORUSURE', 'Désolé, nous avons rencontré une erreur');
//2.2
define('_AM_ADSLIGHT_UPGRADEFAILED0', "Mise à jour");
define('_AM_ADSLIGHT_UPGRADEFAILED1', "Échec de la mise à jour - impossible d'ajouter de nouveaux champs");
define('_AM_ADSLIGHT_UPGRADEFAILED2', "La mise à jour a échoué - impossible de renommer la table '%s'");
define('_AM_ADSLIGHT_ERROR_COLUMN', 'Impossible de créer une colonne dans la base de données : %s');
define('_AM_ADSLIGHT_ERROR_BAD_XOOPS', 'Ce module nécessite XOOPS %s+ (%s installé)');
define('_AM_ADSLIGHT_ERROR_BAD_PHP', 'Ce module nécessite une version PHP %s+ (%s installé)');
define('_AM_ADSLIGHT_ERROR_TAG_REMOVAL', 'Impossible de supprimer les tags du module Tag');


//new
//Buttons
define('AM_ADSLIGHT_ADD_LISTING', 'Ajouter une nouvelle annonce');
define('AM_ADSLIGHT_LISTING_LIST', 'Liste des annonces');

// Listing
define('AM_ADSLIGHT_LISTING_ADD', 'Ajouter une annonce');
define('AM_ADSLIGHT_LISTING_EDIT', 'Modifier l\'annonce');
define('AM_ADSLIGHT_LISTING_DELETE', 'Supprimer l\'annonce');
define('AM_ADSLIGHT_LISTING_LID', '#');
define('AM_ADSLIGHT_LISTING_CID', 'Catégorie');
define('AM_ADSLIGHT_LISTING_TITLE', 'Titre');
define('AM_ADSLIGHT_LISTING_STATUS', 'Statut');
define('AM_ADSLIGHT_LISTING_EXPIRE', 'Expire');
define('AM_ADSLIGHT_LISTING_TYPE', 'Type');
define('AM_ADSLIGHT_LISTING_DESCTEXT', 'Desc');
define('AM_ADSLIGHT_LISTING_TEL', 'Tél');
define('AM_ADSLIGHT_LISTING_PRICE', 'Prix');
define('AM_ADSLIGHT_LISTING_TYPEPRICE', 'Type de prix');
define('AM_ADSLIGHT_LISTING_TYPEUSURE', 'État');
define('AM_ADSLIGHT_LISTING_DATE', 'Date ');
define('AM_ADSLIGHT_LISTING_EMAIL', 'Courriel');
define('AM_ADSLIGHT_LISTING_SUBMITTER', 'Déposant');
define('AM_ADSLIGHT_LISTING_USID', 'Usid');
define('AM_ADSLIGHT_LISTING_TOWN', 'Ville');
define('AM_ADSLIGHT_LISTING_COUNTRY', 'Pays');
define('AM_ADSLIGHT_LISTING_CONTACTBY', 'Contacter par');
define('AM_ADSLIGHT_LISTING_PREMIUM', 'Premium');
define('AM_ADSLIGHT_LISTING_VALID', 'Valider');
define('AM_ADSLIGHT_LISTING_PHOTO', 'Photo');
define('AM_ADSLIGHT_LISTING_HITS', 'Hits');
define('AM_ADSLIGHT_LISTING_ITEM_RATING', 'Note ');
...
define('AM_ADSLIGHT_LISTING_COMMENTS', 'Commentaires');
define('AM_ADSLIGHT_LISTING_REMIND', 'Rappeler');
//General
define('AM_ADSLIGHT_FORMOK', 'Enregistré avec succès');
define('AM_ADSLIGHT_FORMDELOK', 'Supprimé avec succès');
define('AM_ADSLIGHT_FORMSUREDEL', "Êtes-vous sûr de vouloir supprimer : <span class='bold red'>%s</span></b>");
define('AM_ADSLIGHT_FORMSURERENEW', "Êtes-vous sûr de vouloir renouveler : <span class='bold red'>%s</span></b>");
define('AM_ADSLIGHT_FORMUPLOAD', 'Envoi');
define('AM_ADSLIGHT_FORMIMAGE_PATH', 'Le fichier est présent dans %s');
define('AM_ADSLIGHT_FORM_ACTION', 'Action');
define('AM_ADSLIGHT_SELECT', 'Sélectionner une action pour le ou les éléments sélectionnés');
define('AM_ADSLIGHT_SELECTED_DELETE', 'Supprimer les éléments sélectionnés');
define('AM_ADSLIGHT_SELECTED_ACTIVATE', 'Activer les éléments sélectionnés');
define('AM_ADSLIGHT_SELECTED_DEACTIVATE', 'Désactiver les éléments sélectionnés');
define('AM_ADSLIGHT_SELECTED_ERROR', 'Vous n\'avez rien sélectionné à supprimer');
define('AM_ADSLIGHT_CLONED_OK', 'Enregistrement cloné avec succès');
define('AM_ADSLIGHT_CLONED_FAILED', 'Le clonage de l\'enregistrement a échoué');
